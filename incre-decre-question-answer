// Question: Create a React component called Greeting that takes a name prop and displays a greeting message. If the name prop is not provided, it should display a default message. Additionally, provide an optional className prop that allows custom styling of the greeting.
